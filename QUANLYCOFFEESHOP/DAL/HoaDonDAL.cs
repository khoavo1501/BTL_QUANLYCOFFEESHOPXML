...
namespace QUANLYCOFFEESHOP.DAL
{
    public class HoaDonDAL
    {
        ...
        public HoaDonDTO GetByID(string maHD)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Lỗi tìm hóa đơn: " + ex.Message);
            }
        ...
        public bool Insert(HoaDonDTO hoaDon)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Lỗi thêm hóa đơn: " + ex.Message);
                return false;
            }
        }
        ...
        public List<HoaDonDTO> GetByDateRange(DateTime tuNgay, DateTime denNgay)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Lỗi lấy hóa đơn theo ngày: " + ex.Message);
            }
        ...
        public string GenerateNewMaHD()
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Lỗi tạo mã hóa đơn: " + ex.Message);

...
namespace QUANLYCOFFEESHOP.DAL
{
    public class CTHoaDonDAL
    {
        ...
        public List<CTHoaDonDTO> GetByMaHD(string maHD)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("L?i ??c chi ti?t hóa ??n: " + ex.Message);
            }
        ...
        public bool Insert(CTHoaDonDTO chiTiet)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("L?i thêm chi ti?t hóa ??n: " + ex.Message);
                return false;
            }
        }
        ...
        public DataTable GetDetailedByMaHD(string maHD)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("L?i l?y chi ti?t hóa ??n: " + ex.Message);

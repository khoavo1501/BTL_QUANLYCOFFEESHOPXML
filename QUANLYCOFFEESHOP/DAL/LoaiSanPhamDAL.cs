...
namespace QUANLYCOFFEESHOP.DAL
{
    public class LoaiSanPhamDAL
    {
        ...
        public LoaiSanPhamDTO GetByID(string maLoai)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("L?i tìm lo?i s?n ph?m: " + ex.Message);
            }
        ...
        public bool Insert(LoaiSanPhamDTO loaiSanPham)
        {
            try
            {
                ...
                {
                    System.Windows.Forms.MessageBox.Show("Mã lo?i ?ã t?n t?i!");
                    return false;
                }
            ...
            {
                System.Windows.Forms.MessageBox.Show("L?i thêm lo?i s?n ph?m: " + ex.Message);
                return false;
            }
        }
        ...
        public bool Delete(string maLoai)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("L?i xóa lo?i s?n ph?m: " + ex.Message);
                return false;
            }
        }
    }
